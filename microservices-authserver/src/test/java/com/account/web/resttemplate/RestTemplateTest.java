...
public class RestTemplateTest {
	...
	public static final String POST_SAVE_URL = "http://localhost:9999/user/adduser";
	public static final String POST_LOGIN_URL = "http://localhost:9999/user/login";
	public static final String POST_UPDATE_PWD_URL = "http://localhost:9999/user/setpassword";
	public static final String GET_BY_ID_URL = "http://localhost:9999/user/getuserbyid/1";
	public static final String GET_BY_NAME_URL = "http://localhost:9999/user/getuserbyname/kishore";
	public static final String GET_FIND_ALL_URL = "http://localhost:9999/user/listofusers";
	public static final String PUT_BY_ID_URL = "http://localhost:9999/user/update/1";
	public static final String DELETE_BY_ID_URL = "http://localhost:9999/user/delete/1";
